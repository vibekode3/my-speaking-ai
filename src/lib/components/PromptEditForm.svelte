<!-- src/lib/components/PromptEditForm.svelte -->
<script>
...
<div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
	<h4 class="font-medium text-gray-700 mb-3">프롬프트 편집</h4>
	<div class="space-y-3">
		<div>
		...
		<div class="flex items-center">
			<input
				...
				disabled={isConnected}
			/>
			<label for="edit-favorite" class="text-sm text-gray-700">즐겨찾기에 추가</label>
		</div>
	</div>
	<div class="flex gap-2 mt-4">
		<button
			...
			class="flex-1 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
		>
			수정하기
		</button>
		<button
